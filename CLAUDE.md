...
- **Build status:** Milestones 1–4 done (converter + local images + incremental change-detection + sparse archive; all verified against the real export). Next (see `docs/ghost-to-vault.md` §7): scripted export via session auth (M5), RSS watch (M6).
